...
if ~exist(sprintf("data/%s/movie",M.save_pars.sim_identifier),"dir")
    mkdir(sprintf("data/%s/movie",M.save_pars.sim_identifier))
end

M.vid = VideoWriter(sprintf("data/%s/movie/out.mp4",M.save_pars.sim_identifier),'MPEG-4');
