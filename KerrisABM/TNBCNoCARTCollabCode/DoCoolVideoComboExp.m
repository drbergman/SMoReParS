...
%cd Data/AA_30__BB_4/OverTime
cd Data/AA_0__AB_150/BB_1/OverTime
allTheFrames = cell(iterend,1);

allTheColorMaps = cell(iterend,1);
allTheColorMaps(:) = {zeros(256, 3)};

myMovie = struct('cdata', allTheFrames, 'colormap', allTheColorMaps);

for iter = 10:10:iterend
