...
%Creating a Parameter Space for Collaboration with Harsh and Trace
%There are NO CART cells because CARTdelay is set to 1500
...
[AA,AB,BB] = meshgrid([0.05,0.125,0.245], [8,12,15], linspace(5,6,2));%
