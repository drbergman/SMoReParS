...
function [grid] = fillAgentGrid3(grid, seg, r1, r2, pixelsize, onlyAgentGridNeeded)
...
grid = makeSphere2(grid, r1, radius, indices,onlyAgentGridNeeded); %or make Circle(grid, r3, radius, 3)
...
if units > 0   
    for j = 1:units 
        ...
        grid = makeSphere2(grid, r3, radius, indices,onlyAgentGridNeeded); %Set the sphere to 1
    end
end

%Fill the first position of the segment 
grid = makeSphere2(grid, r2, radius, indices,onlyAgentGridNeeded);
