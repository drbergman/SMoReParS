...
file_name = "Profiles_SMFromABM_New_original";

files.optimal_parameters = "../ODEFitting/data/SMFitToABM_New_original.mat";
...
load("../ODEFitting/data/SMFitToData_New_original.mat","fn","lb","ub","fn_opts","optim_opts")
...
%% perform profile
profiles = performProfile_original(files,objfn_constants,profile_params,options);
