...
cells_on_left = M.tumor(:,M.I.subs(1))==1;
neighbor_inds(M.pars.left_neighbors_VN_ind,cells_on_left) = M.tumor(cells_on_left,M.I.ind);
cells_on_right = M.tumor(:,M.I.subs(1))==M.grid.size(1);
neighbor_inds(M.pars.right_neighbors_VN_ind,cells_on_right) = M.tumor(cells_on_right,M.I.ind);
cells_on_front = M.tumor(:,M.I.subs(2))==1;
neighbor_inds(M.pars.front_neighbors_VN_ind,cells_on_front) = M.tumor(cells_on_front,M.I.ind);
cells_on_back = M.tumor(:,M.I.subs(2))==M.grid.size(2);
neighbor_inds(M.pars.back_neighbors_VN_ind,cells_on_back) = M.tumor(cells_on_back,M.I.ind);
cells_on_bottom = M.tumor(:,M.I.subs(3))==1;
neighbor_inds(M.pars.bottom_neighbors_VN_ind,cells_on_bottom) = M.tumor(cells_on_bottom,M.I.ind);
cells_on_top = M.tumor(:,M.I.subs(3))==M.grid.size(3);
neighbor_inds(M.pars.top_neighbors_VN_ind,cells_on_top) = M.tumor(cells_on_top,M.I.ind);
...
tum_region = M.tumor(:,M.I.region_fgfr3);
