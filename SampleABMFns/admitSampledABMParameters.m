...
assert(npars_sm==size(P_data.out{1},1)-1) % need the data profiles to save all parameter values, not just the profiled parameter
...
out = admitByMethod(vals,BS,P_data.out,opts);
